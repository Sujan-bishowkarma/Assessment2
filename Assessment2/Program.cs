...
namespace Assessment2
{
    ...
    class LanghamHotelManagementSystem
    {
        private List<Room> rooms;

        public LanghamHotelManagementSystem()
        {
            rooms = new List<Room>();
        }
        ...
        public void SaveTheRoomAllocationToaFile()
        {
            // create a file
            FileStream fs = new FileStream("C:\\Users\\suraj\\source\\repos\\lhms_studentid.txt", FileMode.Create);
            fs.Close();

            try
            {
                string file = @"C:\\Users\\suraj\\source\\repos\\lhms_studentid.txt";
        ...
        public void ShowTheRoomAllocationFromaFile()
        {
            // Specify the file path
            string filePath = "C:\\Users\\suraj\\source\\repos\\lhms_studentid.txt";
        ...
        {
            // Create backup file
            FileStream fs = new FileStream("C:\\Users\\suraj\\source\\repos\\lhms_studentid_backup.txt", FileMode.Create);
            fs.Close();

            try
            {
                string backupfile = @"C:\\Users\\suraj\\source\\repos\\lhms_studentid_backup.txt";
                string filePath = "C:\\Users\\suraj\\source\\repos\\lhms_studentid.txt";
                if (File.Exists(filePath))
                {
                    using (StreamReader reader = new StreamReader(filePath))
        ...
        {
            LanghamHotelManagementSystem hotelSystemMenu = new LanghamHotelManagementSystem();
            while (true)
            {
                Console.WriteLine("******************************************");
                ...
                Console.WriteLine("10. Backup Room Allocation");
                Console.WriteLine("******************************************");
                ...
                try
                {
                    ...
                    {
                        case 1:
                            hotelSystemMenu.AddRooms();
                            break;
                        case 2:
                            hotelSystemMenu.DisplayRooms();
                            break;
                        case 3:
                            hotelSystemMenu.AllocateRooms();
                            break;
                        case 4:
                            hotelSystemMenu.DeAllocateRooms();
                            break;
                        case 5:
                            hotelSystemMenu.DisplayRoomAllocationDetails();
                            break;
                        case 6:
                            hotelSystemMenu.Billing();
                            break;
                        case 7:
                            hotelSystemMenu.SaveTheRoomAllocationToaFile();
                            break;
                        case 8:
                            hotelSystemMenu.ShowTheRoomAllocationFromaFile();
                            break;
                        case 9:
                            Environment.Exit(0);
                            break;
                        case 10:
                            hotelSystemMenu.BackupRoomAllocation();
                            break;
